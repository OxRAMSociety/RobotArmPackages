...
#include "rbx1_hardware_interface/ArmJointState.h"
#include "math.h"

rbx1_hardware_interface::ArmJointState arm_steps;
rbx1_hardware_interface::ArmJointState total;
...
void cmd_cb(const sensor_msgs::JointState& cmd_arm)
{
  ...
  // ros::Publisher pub = nh.advertise<rbx1_hardware_interface::ArmJointState>("joint_steps",50);
...
{
  ros::init(argc, argv, "angles_to_steps");
  ros::NodeHandle nh;

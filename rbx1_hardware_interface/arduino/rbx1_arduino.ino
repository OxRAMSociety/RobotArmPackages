...
void arm_cb(const rbx1_hardware_interface::ArmJointState& arm_steps){
  joint_status = 1;
...
ros::Subscriber<rbx1_hardware_interface::ArmJointState> arm_sub("joint_steps",arm_cb); //subscribes to joint_steps on arm
